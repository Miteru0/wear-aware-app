...
public class GameFrameVisualTest {
    ...
    public static void main(String[] args) {
        ...
        List<Question> questions = Arrays.asList(
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "EASY"),
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "EASY"),
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "Medium"),
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "Medium"),
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "Hard"),
                new Question(sampleText, sampleExplanationRight, sampleExplanationWrong, "1", "Hard"));
